...
const WORDS = ["iOS Developer","AI/ML Engineer", "Web Developer", "UI/UX Designer"];
const TECH_STACK = ["Swift","Python","React", "Javascript", "Node.js", "Tailwind", "C/C++"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/tejasviverma" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/tejasvi-verma-b641342b5/" },
  { icon: Instagram, link: "https://www.instagram.com/tejasvviii/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I love creating immersive and  personal websites for clients that blend functionality with visually appealing designs.
                </p>
