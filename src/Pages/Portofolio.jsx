            ...
            <div className="container mx-auto flex justify-center items-center overflow-hidden">
              ...
              {displayedCertificates.map((certificate, index) => (
                <div
                     ...
                     data-aos-duration={index % 3 === 0 ? "1000" : index % 3 === 1 ? "1200" : "1000"}
                >
               <CertificateList ImgSertif={certificate.image} name={certificate.name} description={certificate.description} link={certificate.link} />
                </div>
              ))}
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {sideProjects.map((project, index) => (
                 <div
                  ...
                  data-aos={index % 3 === 0 ? "fade-up-right" : index % 3 === 1 ? "fade-up" : "fade-up-left"}
                  data-aos-duration={index % 3 === 0 ? "1000" : index % 3 === 1 ? "1200" : "1000"}
                  className="p-5 rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm text-slate-300"
                >
